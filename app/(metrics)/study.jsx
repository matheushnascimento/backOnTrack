          ...
          >
            ...
            >
              ...
              <MyView safe={false} className="flex-row items-end gap-1">
                <TextInput
                  className="h-[51px] w-20 max-w-[160px] rounded-lg bg-light-backgroundCard dark:bg-dark-backgroundCard p-1.5 text-center text-[26px] font-bold text-light-text dark:text-dark-text"
                  placeholder="--"
